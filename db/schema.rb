...
ActiveRecord::Schema.define(version: 20140925140846) do
  ...
  add_index "responses", ["question_id", "answer_choice_id"], name: "index_responses_on_question_id_and_answer_choice_id", using: :btree
